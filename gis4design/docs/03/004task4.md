...
Please read [](../01/02crs) to have a better understanding of the coordinate reference system.

1. Before starting this task, please refer to [](002open_data1) & [](003vec_lay) tasks. You will require materials and knowledge from these two tasks to complete this task.
